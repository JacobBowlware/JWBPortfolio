    ...
    return (
        <div className="footer">
            ...
            <div className="footer__body">
                ...
                <a className="footer__body-text" href="https://github.com/JacobBowlware" target="_blank" rel="noreferrer"><FontAwesomeIcon className="hero-card__icon" icon="fa-brands fa-github" /> GitHub</a>
